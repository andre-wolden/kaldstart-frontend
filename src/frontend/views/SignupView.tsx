...
const signUpForm = (signupDataResponse: RemoteData<ErrorMessageResponse, SignUpDataResponse>) => {
    return fold(
...
export const LoginView: React.FC = () => {
    ...
    return (
        <div>
            <div>Sign up</div>
            <StyledDiv>Sign up form:</StyledDiv>
            <StyledDiv>{signUpForm(loginDataResponsesignupDataResponse}</StyledDiv>
            SignUpDataResponseStyledDiv> ------------------------- </StyledDiv>
