...
import { defaultConfig } from '../../pkg';
import { setSession } from '../../pkg/middleware';
import { RouteCreator, RouteRegistrator } from '../../pkg/route';

export const createWelcomeRoute: RouteCreator = createHelpers => async (req, res) => {
